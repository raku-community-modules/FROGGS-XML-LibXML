...
# 4.1 Normalization on an Element node
{
    ...
    # TEST
    #ok ! $t2.parentNode.defined, '2nd text node has no parent';
    # TEST
    #ok ! $t3.parentNode.defined, '3rd text node has no parent';
}
...
# 4.2 Normalization on a Document node
{
    ...
    # TEST
    #ok ! $t2.parentNode.defined, ' TODO : Add test name');
    # TEST
    #ok ! $t3.parentNode.defined, ' TODO : Add test name');
}
...
# 5. XML::LibXML extensions
{
    ...
    # TEST
    ok  ! @cn[1].hasChildNodes, 'second child has no descendants';
    # TEST
