...
class XML::LibXML::Attr     is repr<CStruct> { ... }
class XML::LibXML::Node     is repr<CStruct> { ... }
class XML::LibXML           is repr<CStruct> { ... }
...
class XML::LibXML::Document is XML::LibXML::Node is repr('CStruct') {
    has OpaquePointer $._private; # application data
    ...
    #~ method version() {
        #~ Proxy.new(
            #~ FETCH => -> $ {
                #~ say nqp::getattr(nqp::decont(self), XML::LibXML::Document, '$!version');
    ...
    method new(:$version = '1.0', :$encoding) {
        ...
        say nqp::getattr(nqp::decont($doc), XML::LibXML::Document, '$!version');
